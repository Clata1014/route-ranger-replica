...
export default function PenaltyScreen({ onComplete, message }: PenaltyScreenProps) {
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-red-50 to-red-100 flex flex-col items-center justify-center p-6 text-center animate-shake">
      <img
      ...
      <h1 className="font-display text-2xl text-red-700 mb-3">
        🚨 ERROR GERENCIAL GRAVE 🚨
      </h1>
      <p className="text-red-900/90 text-sm mb-8 max-w-sm whitespace-pre-line">
      ...
      <p className="text-red-700/60 mt-4 text-xs">
